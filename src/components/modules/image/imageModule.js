...
function dragImage(e) {
  ...
  var imgModule = '<div id="' + imgBlockId + '" class="imageBlock">'+
                            '<div class="imageWrapper" style="width: 350px;"><div class="image_settings">'+
						          '<span class="glyphicon glyphicon-cog imgSet"></span>'+
                                  '<span class="glyphicon glyphicon-arrow-left"></span>'+
                                  '<span class="glyphicon glyphicon-align-center"></span>'+
                                  '<span class="glyphicon glyphicon-arrow-right"></span>'+
								  '<span class="glyphicon glyphicon-duplicate copyImg"></span>'+
								  '<span class="glyphicon glyphicon-remove"></span>'+
                              '</div>'+
                              '<div class="border" id="' + getRandom() + '">'+
                                '<img class="img" src="https://avatars.mds.yandex.net/get-pdb/38069/9013e3ba-b082-46eb-9873-512724423a84/s1200?webp=false" alt="image">'+
...
export { dragImage,  addFunctionalityToElement};